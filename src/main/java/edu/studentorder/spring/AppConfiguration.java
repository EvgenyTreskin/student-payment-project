package edu.studentorder.spring;
...
@Configuration
@ComponentScan({ "edu.studentorder" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "edu.studentorder");
                servletContext.setInitParameter("tapestry.development-modules", "edu.studentorder.services.DevelopmentModule");
